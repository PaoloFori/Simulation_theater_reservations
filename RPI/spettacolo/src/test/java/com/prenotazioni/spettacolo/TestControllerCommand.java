...
public class TestControllerCommand extends SpettacoloApplicationTests {
	...
	public void insertNewShowExistsSala() {
		String response = spettacoloControllerCommand.insertNewShowKnewSala("Minnie", 5, Arrays.asList(1));
		assertTrue(response.equals("New Show added correctly"));
	}

	@Test
	public void insertNewSala() {
		String response = spettacoloControllerCommand.addSalaByShow("Aladin",
				new Sala(6, Arrays.asList(new Posto("a", 1, false), new Posto("a", 2, false), new Posto("b", 1, true),
						new Posto("b", 2, true))));
	...
	public void insertExistsSala() {
		String response = spettacoloControllerCommand.addExistsSalaByShow("Aladin", Arrays.asList(3));
